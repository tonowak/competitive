...
struct Debug {
	...
	constexpr static int inf = 0x3f3f3f3f; constexpr static long long inf_l = 0x3f3f3f3f3f3f3f3f;
...
constexpr int Debug::inf; constexpr long long Debug::inf_l;
struct DebugOff { 
...
int main() {
	...
	D << "Debug::inf wynosi 1061109567 (trochę większe od 1e9). Można spokojnie pomnożyć inf przez 2 i dodać jeszcze 25264512 (>2e7) i nie przekroczy inta.";
	D << "Podobnie Debug::inf_l wynosi lekko ponad 4.5e18, a limit long longa = 2^63-1, czyli lekko ponad 9.2e18.";
	D << "Dodatkowo, jak Debug spotka przy wypisywaniu jakiegoś inf, to wypisze zamiast tego odpowiednio znak + albo -:";
	D << I(Debug::inf) << I(-Debug::inf) << I(Debug::inf_l) << I(-Debug::inf_l);
